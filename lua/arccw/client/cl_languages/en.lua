...
L["arccw.cvar.embracetradition"]          = "Classic Old Customization HUD"
L["arccw.cvar.embracetradition.desc"]     = "Use the classic bulky customization HUD. Works only with old customization menu. Good on 4:3."
