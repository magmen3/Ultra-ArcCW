...
local ClientPanel = {
	...
	{ type = "b", text = "Hide customization stats", var = "arccw_hidestats" },
	{ type = "c", text = "For nabs" },
...
local ServerPanel = {
	...
	{ type = "b", text = "Disable 'non-realistic' attachment slots (realism mode)", var = "arccw_realism", sv = true },
